  ...
  <Page>
    <Content>
      ...
      <StoriesContainer>
        <Col tw="lg:w-1/2">
          <StoriesHeaderText>
            {`From Brooke's Perspective...`.toUpperCase()}
          </StoriesHeaderText>
          <StoryText>
        ...
        <Col tw="lg:w-1/2">
          <StoriesHeaderText>
            {`From Nick's Perspective...`.toUpperCase()}
          </StoriesHeaderText>
          <StoryText>
...
const StoriesContainer = styled(Col)(() => [
  tw`
    w-full
    lg:flex-row
...
const StoriesHeaderText = styled.p(() => [
  tw`
    font-weiss
    text-darkTerracotta
