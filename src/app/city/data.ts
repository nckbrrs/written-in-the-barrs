...
export const POIs: Record<string, POI[]> = {
  COFFEE: [
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAUpugR638Yv9eAgGwudNTB6pMzkQa2cCniOZK",
      name: "Jubala\nCoffee",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAaoAi6fjJdObmiIK45yv8p6Vn7qxNHtz2lMCY",
      name: "Sola\nCoffee",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCA07CrqyxzKDG5VULlBdwZ3RFxyaToPgjIWiEQ",
      name: "Idle Hour\nCoffee",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCA9LrCrbRJolm4aZSpBrbzFNkEq7DeP8dxjI1G",
      name: "Iris\nCoffee Lab",
  ...
  FOOD: [
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAkmBfuRgAmpfzBjgeb6lHyZPR2E5ti0WxnTco",
      name: "Benchwarmers\nBagels",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAQX5UAPONZGmDbRnH3l4Kvi6kW0LXPe2SrwfJ",
      name: "BB's Crispy\nChicken",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCADiuZPukFaxh0mqb7rcvXGt5AEj3VQu8Pop6L",
      name: "Whiskey\nKitchen",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCA1uy40FUCrLKcVt7jz6qxduhmf8wQOP324YXk",
      name: "Standard\nBeer+Food",
  ...
  SWEETS: [
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAPBpNDYcwCMUHqYzt8hFuJABxvQTDecRSlb1O",
      name: "Two Roosters\nIce Cream",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAnJLbNR8eTcVtGg01KQXuUqZbosBJCz65aLvh",
      name: "Idle Hour\nCoffee",
      websiteHref: "https://www.instagram.com/idlehour_coffee/",
      locationHref:
        "https://maps.apple.com/?address=1818%20Oberlin%20Rd,%20Unit%20103,%20Raleigh,%20NC%2027608,%20United%20States&auid=10343519929642603386&ll=35.808810,-78.655007&lsp=9902&q=Idle%20Hour%20Coffee%20Roasters&_ext=CjIKBQgEEOIBCgQIBRADCgQIBhAICgQIChAACgQIUhABCgQIVRAPCgQIWRACCgUIpAEQARImKTHW7ZP05kFAMUO4LN1JqlPAOa+rE/Aa6EFAQUWg4WCUqVPAUAM%3D",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAizWQ0ahSEhQqOwDIT2p6lFHbCLJtvyu7rofV",
      name: "Layered\nCroissanterie",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCANEIGCPSidxQ8ny3zE2AtJujcWZV6kC1DobGR",
      name: "The Cupcake\nShoppe",
  ...
  FUN: [
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCABaKSWadTI41D2dWwpgELZxAmiXeO8qjHbzVl",
      name: "Boxcar\nBarcade",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCArXqH4kz46UaQ2E5wN7lGqgt0HofPsuAh8SjR",
      name: "Moore Square\nPark",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCA9lMtZDKRJolm4aZSpBrbzFNkEq7DeP8dxjI1",
      name: "Crabtree\nValley Mall",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAcsjMZWQ71JPar2AI3GBQpDjo09ONwyl6WfCs",
      name: "NC Museum\nof Art",
  ...
  STAY: [
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAguVhOJGrYPjORSlNuAvTEGzamD5y4d9Ue0ct",
      name: "The Mayton\nInn",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAVUncfZPCl86eO5g4TaNQLHJYDkfcSWnMrPI1",
      name: "Springhill\nSuites",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCAcZAFZ3Q71JPar2AI3GBQpDjo09ONwyl6WfCs",
      name: "Homewood\nSuites",
    ...
    {
      imageSrc: "https://huy0t4exz6.ufs.sh/f/G7HhnnrqUvCALPYYXy1UnBLz8ZsjXfQc0PqF9TAp5NSDtwYV",
      name: "Hyatt\nHouse",
      websiteHref:
